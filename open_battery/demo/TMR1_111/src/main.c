...
void main() {
  ...
  //===============
  IIC_ADDRESS =
      0X23; // 关闭低功耗    第一次上电误进无线充模式，上电稳定后复位1次IC
  SW6303_IIC_READ();
  IIC_DAT |= (1 << 0);
  SW6303_IIC_WRITE();
  ...
  while (1) {
    ...
    if (power_time_1ms > 100) {
      ...
      {
        GET_ADC_VALUE();
        //				if((last_dizuo_adc-dizuo_adc > 200) &&
        //(dizuo_adc<50))
        //				{
        //					dizuo_adc_level = 1;
        //
        //				}
        //				if((dizuo_adc - last_dizuo_adc > 200) &&
        //(dizuo_adc>150))
        //				{
        //					dizuo_adc_level = 0;
        //				}
        ...
        if (sw6301_num !=
            1) // 新增测试需求，1.5S内5次开C口充电  底座在线恢复不充电
        {
          sw6301_num = 1;
          SW6301_SET_H();      // 置高位
          IIC_ADDRESS = 0X14B; //
...
//				SW6301_IIC_WRITE();
//
//			}else if(key_time_1ms > 5  && key_time_1ms< 500)   //
//单击
//			{
//				key_sta = 1;
//				sleep_time_1ms = 0;
...
//							LED1 = 0;
//							if(LED_Bright &  0X02)
//{LED3_OUT; LED3 = 1; }	//  202 							if(LED_Bright &  0X20) {LED2_OUT; LED2 =
//1; }  //  206 					break;
...
//							LED2 = 0;
//							if(LED_Bright &  0X10)
//{LED1_OUT; LED1 = 1; }	//  205 							if(LED_Bright &  0X08) {LED3_OUT; LED3 =
//1; }  //  204 					break;
...
//							LED3 = 0;
//							if(LED_Bright &  0X01)
//{LED1_OUT; LED1 = 1; }	//  201 							if(LED_Bright &  0X04) {LED2_OUT; LED2 =
//1; }  //  203 					break;
////					case 3:
////							LED2_OUT;
////							LED2 = 0;
...
void LED_RUN(void) {
  ...
  if (LED_time_1ms >= 0) {
    ...
    //					{
    //							if(LED_Bright &  (1<<2))
    //{LED3_OUT; LED3 = 1; }	//  202 							if(LED_Bright &  (1<<6)) {LED2_OUT; LED2
    //= 1; }  //  206 							LED1_OUT;LED1 = 0; 					}else if(LEDScan_cnt == 1)
    //					{
    //							if(LED_Bright &  (1<<5))
    //{LED1_OUT; LED1 = 1; }	//  205 							if(LED_Bright &  (1<<4)) {LED3_OUT; LED3
    //= 1; }  //  204 							LED2_OUT; LED2 = 0; 					}else if(LEDScan_cnt == 2)
    //					{
    //							if(LED_Bright &  (1<<1))
    //{LED1_OUT; LED1 = 1; }	//  202 							if(LED_Bright &  (1<<3)) {LED2_OUT; LED2
    //= 1; }  //  206 							LED3_OUT; LED3 = 0; 					}else if(LEDScan_cnt == 3)
    //					{
    //							if(LED_Bright &  (1<<5))
    //{LED1_OUT; LED1 = 1; LED2_OUT; LED2 = 0;}	//  205
    //					}
